...
enum SourceRegistry {
    ...
    static let classicMarkets: [Source] = [
        ...
        Source(id: "classiccars", name: "ClassicCars.com", category: .classicMarket, kind: .automated,
               searchURL: url("https://classiccars.com/listings/find/1960-1972/international/scout"),
               criteria: standardCriteria + "\nSearched automatically (via the page's structured data); this link opens the same query.",
               requiresLogin: false, providerID: ClassicCarsProvider.providerID,
               notes: "Searched automatically by the app. May fall back to manual if the site blocks the request."),
        ...
        Source(id: "hemmings", name: "Hemmings", category: .classicMarket, kind: .automated,
               searchURL: url("https://www.hemmings.com/classifieds/cars-for-sale/international-harvester/scout/"),
               criteria: standardCriteria + "\nSearched automatically (via the page's structured data). Hemmings also supports email alerts on a saved search.",
               requiresLogin: false, providerID: HemmingsProvider.providerID,
               notes: "Searched automatically by the app. May fall back to manual if the site blocks the request."),
